// ImGui SDL2 binding with OpenGL ES 2, compatible with WebGL when compiled with
// Emscripten https://github.com/ocornut/imgui
...
bool ImGui_ImplSdl_Init(SDL_Window *window) {
  ...
  io.KeyMap[ImGuiKey_Tab] =
      SDLK_TAB; // Keyboard mapping. ImGui will use those indices to peek into
...
void ImGui_ImplSdl_NewFrame(SDL_Window *window) {
  ...
  if (SDL_GetWindowFlags(window) & SDL_WINDOW_MOUSE_FOCUS)
    io.MousePos =
        ImVec2((float)mx, (float)my); // Mouse position, in pixels (set to -1,-1
